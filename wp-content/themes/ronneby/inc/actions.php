...
add_action('after_setup_theme', 'dfd_enqueue_extras');

if(!function_exists('dfd_enqueue_extras')) {
	function dfd_enqueue_extras() {
		global $dfd_ronneby;
		# Envato updater init
...
if(!function_exists('dfd_customization_services_notice')) {
	function dfd_customization_services_notice() {
		...
		<div class="notice notice-success is-dismissible">
			...
			<p><strong><a href="http://support.dfd.name/" title="<?php esc_attr_e('Support center','dfd-native') ?>" target="_blank"><?php esc_html_e('Support center', 'dfd-native') ?></a>&nbsp;|&nbsp;<a href="http://dfd.name/services" title="<?php esc_attr_e('Customization services','dfd-native') ?>" target="_blank"><?php esc_html_e('Customization services', 'dfd-native') ?></a></strong></p>
		</div>
		<?php
	}
}