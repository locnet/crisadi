...
if(!class_exists("Dfd_Google_Map")) {
	class Dfd_Google_Map {
				...
				vc_map( array(
					...
					'params'      => array(
						array(
							...
							'heading'			=> '<span class="dfd-vc-toolip tooltip-bottom"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('This option allows you to choose one of the preset google map styles','dfd').'</span></span>'.  esc_html__( 'Map Style', 'dfd' ),
						...
						array(
							'type'        => 'number',
							'heading' => '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('Specify the map\'s height','dfd').'</span></span>'. esc_html__( 'Map height', 'dfd' ),
							'param_name'  => 'size',
							'edit_field_class' => 'vc_column vc_col-sm-4 crum_vc dfd-number-wrap',
						),
						array(
							'type'       => 'dropdown',
							'heading' => '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('Choose the zoom for the map from the dropdown','dfd').'</span></span>'. __( 'Map Zoom', 'dfd' ),
							'param_name' => 'zoom',
						...
						array(
							...
							'heading' => '<span class="dfd-vc-toolip tooltip-bottom"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('This option allows you to enable or disable zoom for the map','dfd').'</span></span>'. esc_html__( 'Zoom In/Out', 'dfd' ),
						...
						array(
							'type'        => 'attach_image',
							'heading'			=> '<span class="dfd-vc-toolip tooltip-bottom"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('Choose the image from the media library','dfd').'</span></span>'. esc_html__( 'Marker Image', 'dfd' ),
						...
						array(
							'type'        => 'textarea',
							'heading'			=> '<span class="dfd-vc-toolip tooltip-bottom"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('Please, enter the location you need. For example, New York 15 Ford StBrooklyn or latitude and longitude geographic coordinates','dfd').'</span></span>'. esc_html__( 'Map Marker Location', 'dfd' ),
						...
						array(
							...
							'heading'	 => '<span class="dfd-vc-toolip tooltip-bottom"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('This option allows you to specify the style for the info box. Info box will be shown on map.','dfd').'</span></span>'. esc_html__('Info box style','dfd'),
						...
						array(
							'type'        => 'textarea',
							'heading'	 => '<span class="dfd-vc-toolip tooltip-bottom"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('Please paste the shortcode to be displayed in front of the map in this field','dfd').'</span></span>'. esc_html__( 'Contacts block shortcode', 'dfd' ),
							'param_name'  => 'content',
							'admin_label' => true,
						...
						array(
							'type'       => 'textfield',
							'heading'	 => '<span class="dfd-vc-toolip tooltip-bottom"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('Enter the heading for your info box','dfd').'</span></span>'. __( 'Infobox heading', 'dfd' ),
						...
						array(
							...
							'params'      => array(
								array(
									'type' => 'dropdown',
									'heading' => esc_html__( 'Icon library', 'dfd' ),
									'value' => array(
									...
									'description' => __( 'Select icon library.', 'dfd' ),
								),
								array(
									'type'       => 'iconpicker',
						...
						array(
							'type' => 'dfd_radio_advanced',
							'heading'	 => '<span class="dfd-vc-toolip tooltip-bottom"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('Specify the horizontal alignment for the info box displayed on map','dfd').'</span></span>'. esc_html__('Info box alignment','dfd'),
						...
						array(
							...
							'heading'	 => '<span class="dfd-vc-toolip tooltip-bottom"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('This option allows you to specify the background color for the info box. The default value is #fff','dfd').'</span></span>'. esc_html__('Infobox background', 'dfd'),
							'value' => '',
							'dependency'  => array( 'element' => 'infobox_style', 'value' => array( 'shortcode','contacts' ) ),
							'group'      => esc_html__( 'Info box', 'dfd' ),
						),
						array(
							...
							'heading'	 => '<span class="dfd-vc-toolip tooltip-bottom"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('This option allows you to specify the color for text displayed in the info box. The default value is inherited from Theme Options > Styling Options > Default title color','dfd').'</span></span>'. esc_html__('Infobox text color', 'dfd'),
							'value' => '',
							'dependency'  => array( 'element' => 'infobox_style', 'value' => array( 'contacts' ) ),
							'group'      => esc_html__( 'Info box', 'dfd' ),
						),
						...
						array(
							...
							'group'       => esc_attr__('Responsive Options', 'dfd'),
						),
						array(
							'type'        => 'number',
							'heading'	  => '<span class="dfd-vc-toolip tooltip-bottom"><i class="dfd-vc-tooltip-icon"></i><span class="dfd-vc-tooltip-text">'.esc_html__('Specify the map height which should be displayed on desktops','dfd').'</span></span>'.esc_html__('Map height on desktop', 'dfd'),
							'param_name'  => 'desktop_size',
							'edit_field_class' => 'vc_column vc_col-sm-4 crum_vc dfd-number-wrap',
							'dependency' => array('element' => 'enable_responsive', 'value' => 'enable'),
							'group'       => esc_attr__('Responsive Options', 'dfd'),
						),
						array(
							'type'        => 'number',
							'heading'	  => '<span class="dfd-vc-toolip tooltip-bottom"><i class="dfd-vc-tooltip-icon"></i><span class="dfd-vc-tooltip-text">'.esc_html__('Specify the map height which should be displayed on tablets','dfd').'</span></span>'. esc_html__('Map height on tablet', 'dfd'),
							'param_name'  => 'tablet_size',
							'edit_field_class' => 'vc_column vc_col-sm-4 crum_vc dfd-number-wrap',
							'dependency' => array('element' => 'enable_responsive', 'value' => 'enable'),
							'group'       => esc_attr__('Responsive Options', 'dfd'),
						),
						array(
							'type'        => 'number',
							'heading'	  => '<span class="dfd-vc-toolip tooltip-bottom"><i class="dfd-vc-tooltip-icon"></i><span class="dfd-vc-tooltip-text">'.esc_html__('Specify the map height which should be displayed on mobile','dfd').'</span></span>'. esc_html__('Map height on mobile', 'dfd'),
		...
		function dfd_google_map_form( $atts, $content = null ) {
			...
			$enable_responsive = $desktop_size = $tablet_size = $mobile_size = '';
			...
			$css_rules .= '#'.esc_js($unique_id).' {height: '.esc_js($size).'px;}';
			
			if(isset($enable_responsive) && $enable_responsive = 'enable') {
				if(isset($desktop_size) && $desktop_size != '') {
					$css_rules .= '@media (max-width: 1280px) and (min-width: 1024px) {';
						$css_rules .= '.dfd-gmap-module #'.esc_js($unique_id).' {height: '.esc_js($desktop_size).'px;}';
					$css_rules .= '}';
				}
				if(isset($tablet_size) && $tablet_size != '') {
					$css_rules .= '@media (max-width: 1023px) and (min-width: 800px) {';
						$css_rules .= '.dfd-gmap-module #'.esc_js($unique_id).' {height: '.esc_js($tablet_size).'px;}';
					$css_rules .= '}';
				}
				if(isset($mobile_size) && $mobile_size != '') {
					$css_rules .= '@media (max-width: 799px) {';
						$css_rules .= '.dfd-gmap-module #'.esc_js($unique_id).' {height: '.esc_js($mobile_size).'px;}';
					$css_rules .= '}';
				}
			}
			...
			$block_html .= '<div class="dfd-gmap-module ' . esc_attr($unique_id) . ' ' . esc_attr($animate) . '" ' . $animation_data . '>';
				...
				$block_html .= '<div id="' . esc_attr($unique_id) . '" class="map-holder"></div>';
