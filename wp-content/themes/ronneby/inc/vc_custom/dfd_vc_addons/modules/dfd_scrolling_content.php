			...
			if(function_exists("vc_map")){
				...
				vc_map(
					array(
						...
						'icon' => "dfd_scrolling_content dfd_shortcode",
						'class' => "scroll_content_block",
						...
						'params' => array(
							array(
								'type' => 'colorpicker',
								'heading' => '<span class="dfd-vc-toolip tooltip-bottom"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('This option allows you to specify the background color for animation before and after the content block','dfd').'</span></span>'.__('Animated background color', 'dfd'),
