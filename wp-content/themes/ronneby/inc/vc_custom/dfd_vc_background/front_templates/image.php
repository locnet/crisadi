...
if(in_array($dfd_parallax_style, $simple_styles)) {
	...
	if(isset($dfd_bg_image_size) && $dfd_bg_image_size !== 'manual') {
		$css_rules .= 'background-size: '.esc_attr($dfd_bg_image_size).';';
	}else if(isset($dfd_bg_image_manual_size) && !empty($dfd_bg_image_manual_size) && $dfd_bg_image_size == 'manual') {
		$css_rules .= 'background-size: '.esc_attr($dfd_bg_image_manual_size).';';
	}
...
if(isset($dfd_bg_image_repeat_mobile) && $dfd_bg_image_repeat_mobile != '') {
	$mobile_css .= '#'.esc_attr($uniqid).' {background-repeat: '.esc_attr($dfd_bg_image_repeat_mobile).';}';
}

if(isset($dfd_bg_image_size_mobile) && $dfd_bg_image_size_mobile != '' && $dfd_bg_image_size_mobile !== 'manual') {
	$mobile_css .= '#'.esc_attr($uniqid).' {background-size: '.$dfd_bg_image_size_mobile.';}';
}else if(isset($dfd_bg_image_manual_size_mobile) && !empty($dfd_bg_image_manual_size_mobile) && $dfd_bg_image_size_mobile == 'manual') {
	$mobile_css .= '#'.esc_attr($uniqid).' {background-size: '.esc_attr($dfd_bg_image_manual_size_mobile).';}';
}
