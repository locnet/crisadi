		...
		*/
		...
		<li id="dfd_customization_services_section_group_li" class="redux-group-tab-link-li dark">
			<a href="javascript:void(0);" id="dfd_customization_services_section_group_li_a"
			   class="redux-group-tab-link-a custom-tab" data-rel="dfd_customization_services"><i><img src="<?php echo get_template_directory_uri().'/redux_framework/ReduxCore/assets/img/spanner.png' ?>" width="15" alt="Icon" /></i><span
