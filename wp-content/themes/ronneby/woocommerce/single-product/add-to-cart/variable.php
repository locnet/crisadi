						...
						<?php if ( sizeof($attributes) == $loop ): ?>
							...
							<tr>
								...
								<td class="clear-section">
									...
									<?php
										echo apply_filters( 'woocommerce_reset_variations_link', '<a class="reset_variations" href="#"><i class="dfd-icon-recycle"></i><span class="dfd-reset-vars">' . esc_html__( 'Clear', 'dfd' ) . '</span></a>' );
									?>
