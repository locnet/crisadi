...
<?php if ( ! WC()->cart->is_empty() ) : ?>
	...
	<p class="buttons">
		<a href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="button wc-forward box-name"><?php _e( 'View Cart', 'dfd' ); ?></a>
		<a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="button checkout wc-forward box-name"><?php _e( 'Checkout', 'dfd' ); ?></a>
	</p>
